...
{
    MyViewer v;
    //v.SetObjectColor(Quantity_NOC_RED); // works
    //v.SetEdgeThickness(20.0); // not working
    //v.SetTransparency(0.5); // does not work
    //v.SetBackgroundColor(Quantity_NOC_BLACK); //works
